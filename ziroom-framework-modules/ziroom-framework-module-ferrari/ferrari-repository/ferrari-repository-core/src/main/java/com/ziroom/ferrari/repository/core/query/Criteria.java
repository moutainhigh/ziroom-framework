...
public class Criteria {
    ...
    private static void checkCompareCriteria(String key, Object value) {
        checkKey(key);
        Preconditions.checkArgument(value instanceof Number || value instanceof Date, "Param value was %s, It must be one instance of java.lang.Number or java.util.Date", value);
    }
    ...
    private static void checkEQCriteria(String key, Object value) {
        checkKey(key);
        Preconditions.checkArgument(value == null || value instanceof Number || value instanceof Date || value instanceof String,
                "Param value was %s, It must be one instance of java.lang.Number or java.util.Date or java.lang.String", value);
    }
    ...
    private static void checkCollectionCriteria(String key, Object... value) {
        ...
        if (value.length > MAX_IN_SIZE) {
            throw new RuntimeException("The number of In beyond the maximum limit [100]");
        }
    }
    ...
    private static void checkCollectionCriteria(String key, Collection<?> c) {
        ...
        Preconditions.checkArgument(!c.isEmpty() && c.size() < MAX_IN_SIZE, "Number of parameter values must be within the 0-100");
    }
