package com.ziroom.ferrari.repository.producer.entity;
...
@Table(value = "ferrari_message_archive")
public class FerrariMessageArchive extends IdEntity implements Serializable {
