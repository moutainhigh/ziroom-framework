...
/**
 * Initialize a {@link DataSource} based on a matching {@link org.springframework.boot.autoconfigure.jdbc.DataSourceProperties}
 * config.
 *
 * @author Dave Syer
 * @author Phillip Webb
...
class DataSourceInitializer {
	 ...
	 * {@link org.springframework.boot.autoconfigure.jdbc.DataSourceProperties configuration}.
	 ...
	 */
	DataSourceInitializer(DataSource dataSource, org.springframework.boot.autoconfigure.jdbc.DataSourceProperties properties, ResourceLoader resourceLoader) {
	 ...
	 * @param properties the matching configuration
	 */
	DataSourceInitializer(DataSource dataSource, org.springframework.boot.autoconfigure.jdbc.DataSourceProperties properties) {
	 ...
	 * @see org.springframework.boot.autoconfigure.jdbc.DataSourceProperties#getSchema()
	 */
