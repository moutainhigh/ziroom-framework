...
import com.ziroom.framework.ferrari.repository.core.entity.StringIdEntity;
import com.ziroom.framework.ferrari.repository.core.exception.DaoException;
import com.ziroom.framework.ferrari.repository.core.exception.DaoExceptionTranslator;
import com.ziroom.framework.ferrari.repository.core.exception.DaoMethodParameterException;
import com.ziroom.framework.ferrari.repository.core.interceptor.InterceptorChain;
import com.ziroom.framework.ferrari.repository.core.jdbc.JdbcBaseDao;
import com.ziroom.framework.ferrari.repository.core.jdbc.JdbcSettings;
import com.ziroom.framework.ferrari.repository.core.query.*;
...
public abstract class BaseDao<T> implements IBaseDao<T>, ApplicationContextAware {
    ...
    protected void afterPropertiesSet() {
        ...
        if (t instanceof ParameterizedType) {
            ...
            this.entityClass = (Class<T>) p[ApplicationConstant.INT_0];
        }
...
//            this.setBaseDaoProxy(elasticSearchBaseDao);
    ...
    private static void checkArgumentId(Serializable id) {
        if (id instanceof Long) {
            Preconditions.checkArgument((Long) id > ApplicationConstant.LONG_0, "Param id must be greater than 0");
    ...
    private static void checkArgumentIds(List<Serializable> ids) {
        Preconditions.checkArgument(ids != null && ids.size() > ApplicationConstant.INT_0, "Param ids must be not null and empty");
    ...
    private static void checkArgumentFields(List<String> fields) {
        Preconditions.checkArgument(fields != null && fields.size() > ApplicationConstant.INT_0, "Param fields must be not null");
    }
    ...
    private static void checkArgumentOrderBys(List<OrderBy> orderBys) {
        Preconditions.checkArgument(orderBys != null && orderBys.size() > ApplicationConstant.INT_0, "Param orderBys must be not null");
    }
